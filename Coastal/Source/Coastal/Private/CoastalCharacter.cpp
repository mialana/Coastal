...
void ACoastalCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
    ...
    if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
    {
        ...
        // Moving
        EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACoastalCharacter::Move);
        EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ACoastalCharacter::Look);

        // Looking
        EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ACoastalCharacter::Look);
    }
    else
    {
...
void ACoastalCharacter::Move(const FInputActionValue& Value)
{
    // input is a Vector2D
...
void ACoastalCharacter::Look(const FInputActionValue& Value)
{
    // input is a Vector2D
...
void ACoastalCharacter::DoMove(float Right, float Forward)
{
...
void ACoastalCharacter::DoLook(float Yaw, float Pitch)
{
    if (GetController() != nullptr)
    {
...
void ACoastalCharacter::DoJumpStart()
{
    // signal the character to jump
    Jump();
}

void ACoastalCharacter::DoJumpEnd()
{
